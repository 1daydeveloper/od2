...
const menuItems = {
  ...
  tools: [
    ...
    },
    {
      ...
      badgeText: "NEW",
      isNew: true,
      description: "Preview and copy email templates for testing.",
      features: [
        "Multiple formats (HTML, Text, OTP)",
        "One-click copy for subject and body",
        "Free email sending service planned",
      ],
    },
  ],
};
