...
const menuItems = {
  ...
  tools: [
    ...
    },
    {
      ...
      features: [
        "Real-time conversion – Instant encoding/decoding",
        "Bidirectional – Switch between encode and decode modes",
        "Developer-friendly – Perfect for API testing and debugging",
      ],
    },
  ],
};
