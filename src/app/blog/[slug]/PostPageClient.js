  ...
  return (
    <div className="w-full max-w-none px-4 sm:px-6 lg:px-8 py-8">
      <Card className="max-w-4xl mx-auto !w-full border-none shadow-none bg-transparent">
        <CardHeader className="px-4 sm:px-6 lg:px-8 pb-8 text-center">
      ...
      <Card className="p-4 sm:p-5 lg:p-6 rounded-3xl mt-6">
        ...
        <CardContent className="px-0 pt-0">
          <div className="flex flex-wrap gap-3">
            <Button
              variant="outline"
              className="gap-2 hover:bg-[#1DA1F2] hover:text-white hover:border-transparent transition-colors"
            ...
            <Button
              variant="outline"
              className="gap-2 hover:bg-[#0A66C2] hover:text-white hover:border-transparent transition-colors"
            ...
            <Button
              variant="outline"
              className="gap-2 hover:bg-[#1877F2] hover:text-white hover:border-transparent transition-colors"
            ...
            <Button
              variant="outline"
              className="gap-2 hover:bg-[#25D366] hover:text-white hover:border-transparent transition-colors"
