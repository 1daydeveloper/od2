  ...
  async _establishConnection() {
    try {
      ...
      await mongoose.connect(process.env.MONGODB_URI, {
        ...
        maxPoolSize: 25, // Increase pool size for better concurrency
        minPoolSize: 10, // Increase minimum connections for instant availability
        ...
        w: 1, // Write to primary only (faster than majority)
        wtimeoutMS: 3000, // Reduced from 5000ms for faster processing
